<template>
    <nav class="flex items-center justify-between flex-wrap bg-teal-500 px-6 py-3" x-data="{ open: false }">
        ...
        <div class="block lg:hidden">
            ...
            hover:border-white" @click="open = !open">
        ...
        <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto"
            ...
            <div class="text-sm lg:flex-grow">
                <a href="#responsive-header" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white transition duration-700
